export const Markdown = () => (
	<>
		...
		<p>
			<a href='https://github.com/markedjs/marked/'>Marked</a> lets you convert{' '}
			<a href='http://daringfireball.net/projects/markdown/'>Markdown</a> into
			HTML. Markdown is a simple text format whose goal is to be very easy to
			read and write, even when not converted to HTML. This demo page will let
			you type anything you like and see how it gets converted. Live. No more
			waiting around.
		</p>
		...
		<p>
			That&#39;s it. Pretty simple. There&#39;s also a drop-down option in the
			upper right to switch between various views:
		</p>
		<ul>
			<li>
		...
		<p>
			...
			creator of{' '}
			<a href='http://daringfireball.net/projects/markdown/'>markdown</a> says,
		</p>
		<blockquote>
			<p>
